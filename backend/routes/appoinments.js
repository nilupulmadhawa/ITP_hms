...
router.route("/addAppoinment").post(upload.single("file_path"), (req, res) => {
    ...
    const doctor_category = req.body.doctor_category;
...
router.route("/updateAppoinment/:id").put(async function (req, res) {
    ...
    //destructure
    const { doctor_category, doctor_name, first_name, last_name, age, nic, email, telephone, status, date, appNo, appTime } = req.body;
